...
{
// Pass the value userID
$userid = $_GET['id'];

// connect to the database

// Retrieve the information from the database 
$sql =  "SELECT userid, username, pass, firstname, lastname, telephone, address, email FROM users WHERE userid = '$userid'";
...
<div class="row">
    ...
    <div class=col>
     <?php echo"<a class='button_link' href='product_sale.php?id="  . $row['userid']. " '>Sell  a  product</a>"?> 
    </div>
    <div class=col>
    <?php echo"<a class='button_link' href='product_sale_user.php?id="  . $row['userid']. " '>Products on sale</a>"?>
    </div>
</div>
<div class="row">
<hr class="memberhr">
...
<?php echo"<a class='delete_link' href='account_deletion_confirmation.php?id="  . $row['userid']. " '>Delete account</a>"?>
</div> 
