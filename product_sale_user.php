...
<link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700;900&display=swap" rel="stylesheet"> 
    ...
    <title><?php echo $row['firstname'] . "'s products" . " page"?></title>
</head>
...
<div class="container">
    <div class ="col">
        <div class="row">
        <p class="title3" >Your items on sale</p>
        </div>
        <div class="row">
        <div class="grid-container-products_home">
        <?php
        $sql =  "SELECT title, brand, age, picture, cost, id, userid FROM products WHERE userid = $userid" ;
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
